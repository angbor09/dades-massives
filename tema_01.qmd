...
8.  Importa el *dataset* de mostra («empleats.csv») que hem fet servir a l'explicació (està disponible al Campus Virtual).

9.  Instal·la i executa el paquet `tidyverse`. Fes un recompte de quantes persones hi ha a cadascuna de les ciutats identificades en el *dataset*. A continuació, calcula la mitjana d'edat dels treballadors segons el nivell d'estudis.
